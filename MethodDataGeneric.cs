...
namespace Freyr.EditorMethod
{
    ...
    public class MethodData<TOut> : MethodData
    {
        ...
        public MethodData(Func<TOut> method) : base(method)
        { }
        public Func<TOut> GetMethod => (method ?? (method = ToDelegate<Func<TOut>>())) as Func<TOut>;
    ...
    {
        public MethodData(string methodName, Type targetType) : base(methodName, targetType) { }
        public MethodData(Func<TIn, TOut> method) : base(method) 
        { }
        public Func<TIn, TOut> GetMethod => (method ?? (method = ToDelegate<Func<TIn, TOut>>())) as Func<TIn, TOut>;
    ...
    {
        public MethodData(string methodName, Type targetType) : base(methodName, targetType) { }
        public MethodData(Func<TIn1,TIn2, TOut> method) : base(method)
        { }
        public Func<TIn1, TIn2, TOut> GetMethod => (method ?? (method = ToDelegate<Func<TIn1, TIn2, TOut>>())) as Func<TIn1, TIn2, TOut>;
